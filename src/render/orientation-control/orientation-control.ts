        ...
        if (this.axis !== "none") {
          switch (this.axis) {
            case OrientationControlTargets.TOP: {
              switch (elt.id) {
                case "helper-arrow-top": {
                  dispatchTarget(OrientationControlTargets.BACK);
                }
                  break;
                case "helper-arrow-bottom": {
                  dispatchTarget(OrientationControlTargets.FRONT);
                }
                  break;
                case "helper-arrow-left": {
                  dispatchTarget(OrientationControlTargets.LEFT);
                }
                  break;
                case "helper-arrow-right": {
                  dispatchTarget(OrientationControlTargets.RIGHT);
                }
                  break;
                case "helper-arrow-rotate-right": {
                  dispatchTarget(OrientationControlTargets.TOP_FROM_RIGHT);
                }
                  break;
                case "helper-arrow-rotate-left": {
                  dispatchTarget(OrientationControlTargets.TOP_FROM_LEFT);
                }
                  break;
                default:
                  break;
            ...
            case OrientationControlTargets.BOTTOM: {
              switch (elt.id) {
                ...
                case "helper-arrow-right": {
                  ...
                  break;
                case "helper-arrow-rotate-right": {
                  dispatchTarget(OrientationControlTargets.BOTTOM_FROM_LEFT);
                }
                  break;
                case "helper-arrow-rotate-left": {
                  dispatchTarget(OrientationControlTargets.BOTTOM_FROM_RIGHT);
                }
                  break;
                default:
                  break;
            ...
            case OrientationControlTargets.FRONT: {
              switch (elt.id) {
                case "helper-arrow-top": {
                  dispatchTarget(OrientationControlTargets.TOP);
                }
                  break;
                case "helper-arrow-bottom": {
                  dispatchTarget(OrientationControlTargets.BOTTOM);
                }
                  break;
                case "helper-arrow-left": {
                  dispatchTarget(OrientationControlTargets.LEFT);
            ...
            case OrientationControlTargets.BACK: {
              switch (elt.id) {
                case "helper-arrow-top": {
                  dispatchTarget(OrientationControlTargets.TOP_FROM_BACK);
                }
                  break;
                case "helper-arrow-bottom": {
                  dispatchTarget(OrientationControlTargets.BOTTOM_FROM_BACK);
                }
                  break;
                case "helper-arrow-left": {
                  dispatchTarget(OrientationControlTargets.RIGHT);
