...
import { NodesIcon, ReceiverIcon, RoomIcon, SourceIcon } from "../icons";
...
function MapChildren(props: MapChildrenProps) {
  ...
  switch (container["kind"]) {
    case "surface":
      return (
        <ContextMenu {...ContextMenuSharedProps}>
          <TreeItem icon={<NodesIcon fontSize="inherit" />} {...{
            className,
            label,
            onClick,
            draggable,
    ...
    case "source":
      return (
        <ContextMenu {...ContextMenuSharedProps}>
          <TreeItem icon={<SourceIcon fontSize="inherit" />} {...{
            className,
            label,
            onClick,
            draggable,
    ...
    case "receiver":
      return (
        <ContextMenu {...ContextMenuSharedProps}>
          <TreeItem icon={<ReceiverIcon fontSize="inherit" />} {...{
            className,
            label,
            onClick,
            draggable,
