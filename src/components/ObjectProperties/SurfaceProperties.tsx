      ...
      <div style={SurfacePropertiesContainerStyle}>
...

        {
          <GridRow label={"wireframe"}>
            <CheckboxInput name="wireframeVisible" checked={props.object.wireframeVisible}
                           onChange={props.onPropertyChange} />
          </GridRow>
        }
        ...
        {props.object.hasOwnProperty("_displayVertexNormals") && (
          <GridRow label={"vertex normals"}>
            <CheckboxInput name="displayVertexNormals" checked={props.object.displayVertexNormals}
                           onChange={props.onPropertyChange} />
          </GridRow>
        )}
